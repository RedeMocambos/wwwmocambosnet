...
SECRET_KEY = '8t7_mhesj5zh&amp;+l2&amp;$hqk2&amp;*qh_d&amp;b+ar7q_l6nli1zk7*rdzm'
...
CMS_TEMPLATES = (
    ('paginainicial.html', 'Pagina Inicial'),
    ('nucleo_1.html', 'Nucleo'),
    ('mocambo_1.html', 'Mocambo'),
)
...
ROOT_URLCONF = 'wwwmocambosnet.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wwwmocambosnet.wsgi.application'
